...
Edge terms:
["(1, 2)=>q[1]", "(3, 6)=>q[2]", "(4, 5)=>p[1] + p[3] + q[1] - q[2]", "(1, 6)=>-p[1] - q[1]", "(2, 3)=>-p[2] + q[1]", "(5, 6)=>p[1] + q[1] - q[2]", "(3, 4)=>-p[2] + q[1] - q[2]", "1=>p[1]", "2=>p[2]", "5=>p[3]", "4=>-p[1] - p[2] - p[3]"]  
```
"""
...
#Examples
```julia
julia> G=Feynman.simple_graph([1,2,3,4,5,6,7],[(1,7),(1,2),(2,6),(6,3),(3,4),(7,4),(7,5),(5,6),1,2,3,4,5]);
...
6×6 Matrix{RingElem}:
 0                                                  1//2*t[1]                           …  -1//2*z[3] - 1//2*z[4] + 1//2*z[8] - z[9] - z[11]
 1//2*t[1]                                          0                                      z[11]
 1//2*t[2]                                          1//2*t[4]                              1//2*z[4] - 1//2*z[5]
 1//2*t[3]                                          1//2*t[5]                              -1//2*t[1] - 1//2*t[2] - 1//2*t[3] - 1//2*t[4] - 1//2*t[5] + 1//2*z[5] - 1//2*z[6]
 -1//2*z[1] + 1//2*z[2]                             -1//2*t[1] - 1//2*z[2] + 1//2*z[3]     z[9]
 -1//2*z[3] - 1//2*z[4] + 1//2*z[8] - z[9] - z[11]  z[11]                               …  z[4]
```
"""
