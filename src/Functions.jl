   ...
   #Compute E and Count L
       ...
       for i in 1:length(Nu) 
        if Nu[i]==1
            ...
            continue;
        elseif Nu[i]>1
            error("We consider the integral of the parent diagram,ν_1=...=ν_{k}=1,ν_{k+1}<=0,...,ν_{m}<=0. The vector vevNu=[ν_1,...,ν_{k},ν_{k+1},...,ν_{m}]] is not in the  required form");
        else
            break;
        end
       end
